...
export default function LoginPage() {
    ...
    const submitForm = async()=>{
        ...
        setisLoading(true)
        try{
            const res = await axios.post(BASE_API_URL+"/login",formData)
    ...
    <div className='flex justify-center items-center h-screen'>
        <section class="flex flex-col items-center w-1/2 bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-3xl  dark:border-gray-700 dark:bg-gray-800 ">
            ...
            <div class="w-[60%] max-w-sm  p-4 bg-white sm:p-6 md:p-8 dark:bg-gray-800 ">
                <div class="space-y-6">
                    <h5 class="text-xl font-medium text-gray-900 dark:text-white">Welcome Back! Please Login</h5>
                    <div>
                    ...
                    {!isloading?
                        <button type="button" onClick={submitForm} class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Login to your account</button>
                        :
